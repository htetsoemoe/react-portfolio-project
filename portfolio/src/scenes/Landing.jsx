...
const Landing = ({ setSelectedPage }) => {
    ...
    return (
        ...
        >
            {/* Image Section */}
            <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2"> {/* md:order-2 places as 2nd flex item. */}
                {isAboveLarge ? (
                    <div
                    ...
                    <img
                        src="../src/assets/profile-image.png"
                        alt="profile"
                        className="z-10 w-full maxw-[400px] md:max-w-[600px]"
                    />
                )}
            </div>
